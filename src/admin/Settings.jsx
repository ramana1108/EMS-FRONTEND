...
export default function Settings() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = isUpdate ? await api.updateSettings(settingsId, payload) : await api.createSettings(payload);
          ...
          <div className="employee-directory-card p-6" style={{ backgroundColor: "#ffffff" }}>
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: "32px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <input type="text" name="companyName" value={formData.companyName} onChange={handleChange} placeholder="Acme Solutions Pvt. Ltd." className="input-decorated" />
                    </div>
                  ...
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <input type="text" name="website" value={formData.website} onChange={handleChange} placeholder="https://www.acmesolutions.com" className="input-decorated" />
                    </div>
                  </div>
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <input type="email" name="companyEmail" value={formData.companyEmail} onChange={handleChange} placeholder="info@acmesolutions.com" className="input-decorated" />
                    </div>
                  ...
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <input type="text" name="companyPhone" maxLength={10} value={formData.companyPhone} onChange={handleChange} placeholder="+91 98765 43210" className="input-decorated" />
                    </div>
                ...
                <div className="form-group" style={{ marginBottom: "16px" }}>
                  ...
                  <div className="input-with-icon-container">
                    ...
                    <input type="text" name="companyAddress" value={formData.companyAddress} onChange={handleChange} placeholder="123, Business Park, 5th Floor, Sector 62" className="input-decorated" />
                  </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1.2fr 1fr", gap: "12px" }}>
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <input type="text" name="city" value={formData.city} onChange={handleChange} placeholder="Noida" className="input-decorated" />
                    </div>
                  ...
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <input type="text" name="state" value={formData.state} onChange={handleChange} placeholder="Uttar Pradesh" className="input-decorated" />
                    </div>
                  ...
                  <div className="form-group" style={{ margin: 0, position: "relative" }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <select name="country" value={formData.country} onChange={handleChange} className="input-decorated appearance-none" style={{ paddingRight: "30px" }}>
                    ...
                    {errors.country && <span style={{ fontSize: "11px", color: "#ef4444" }}>{errors.country}</span>}
                  </div>
                  ...
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <input type="text" name="postalCode" maxLength={6} value={formData.postalCode} onChange={handleChange} placeholder="201301" className="input-decorated" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <input type="text" name="systemName" value={formData.systemName} onChange={handleChange} placeholder="Employee Management System" className="input-decorated" />
                    </div>
                  </div>
                  ...
                  <div className="form-group" style={{ margin: 0, position: "relative" }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <select name="timeZone" value={formData.timeZone} onChange={handleChange} className="input-decorated appearance-none" style={{ paddingRight: "30px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                  <div className="form-group" style={{ margin: 0, position: "relative" }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <select name="dateFormat" value={formData.dateFormat} onChange={handleChange} className="input-decorated appearance-none" style={{ paddingRight: "30px" }}>
                  ...
                  <div className="form-group" style={{ margin: 0, position: "relative" }}>
                    ...
                    <div className="input-with-icon-container">
                      ...
                      <select name="currency" value={formData.currency} onChange={handleChange} className="input-decorated appearance-none" style={{ paddingRight: "30px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px", marginTop: "32px" }}>
                <button type="button" onClick={handleReset} className="btn-cancel" style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 20px", borderRadius: "8px" }}>
                  <RotateCcw size={16} />
                  <span>Reset</span>
                </button>
                <button
                  ...
                  style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 24px", borderRadius: "8px", boxShadow: "0 2px 4px rgba(37, 99, 235, 0.2)" }}
                >
                  {loading ? (
                    <>
          ...
          <div className="employee-directory-card p-6" style={{ backgroundColor: "#ffffff" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "14px", marginBottom: "24px" }}>
              <div style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                ...
                <span style={{ fontSize: "13px", color: "#475569" }}>{formData.companyEmail || "info@company.com"}</span>
              </div>

              <div style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                <Phone size={16} style={{ color: "#64748b", marginTop: "2px", flexShrink: 0 }} />
                <span style={{ fontSize: "13px", color: "#475569" }}>{formData.companyPhone || "+91 00000 00000"}</span>
              </div>
